...
public class TopAppIosIndonesia {

	private static final String singapore_ = "http://www.appannie.com/apps/ios/top/indonesia/?date=%s&device=iphone";
	...
	private static final String FileDir = "/home/ubuntu/app_spider_file/indonesia_ios/";
	...
	public static void main(String[] args) {
		...
		while(len < 500) {
			try {
				...
				len++;
				String path = FileDir + date + "_indonesia_ios.txt";
