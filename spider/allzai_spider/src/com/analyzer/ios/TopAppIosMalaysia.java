...
public class TopAppIosMalaysia {

	private static final String singapore_ = "http://www.appannie.com/apps/ios/top/malaysia/?date=%s&device=iphone";
	...
	private static final String FileDir = "/home/ubuntu/app_spider_file/malaysia_ios/";
	...
	public static void main(String[] args) {
		...
		while(len < 500) {
			try {
				...
				len++;
				String path = FileDir + date + "_malaysia_ios.txt";
