...
public class TopAppAndroidIndonesia {

	private static final String singapore_ = "http://www.appannie.com/apps/google-play/top/indonesia/game/?date=%s";
	...
	private static final String FileDir = "/home/ubuntu/app_spider_file/indonesia_android/";
	private static int len = 0;
	
	public static void main(String[] args) {
		
		String country = "印度尼西亚";
		String platform = "安卓";
		...
		while(len < 500) {
			try {
				...
				len++;
				String path = FileDir + date + "_indonesia_android.txt";
