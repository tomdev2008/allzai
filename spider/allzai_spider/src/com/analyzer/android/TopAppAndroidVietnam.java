...
public class TopAppAndroidVietnam {

	private static final String singapore_ = "http://www.appannie.com/apps/google-play/top/vietnam/game/?date=%s";
	...
	private static final String FileDir = "/home/ubuntu/app_spider_file/vietnam_android/";
	...
	public static void main(String[] args) {
		...
		while(len < 500) {
			try {
				...
				len++;
				String path = FileDir + date + "_vietnam_android.txt";
